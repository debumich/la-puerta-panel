const NAV_ITEMS = [
  ...
  { id: 'profile', label: 'Профиль', icon: '<circle cx="12" cy="9" r="4"/><path d="M5 21a7 7 0 0 1 14 0"/><rect x="3" y="3" width="18" height="18" rx="4"/>' }
];
...
function renderSidebar(){
  ...
  el.innerHTML = `
    ...
    <div class="sidebar-foot">
      ${u ? `
        <div class="me-card" data-tab="profile" role="button" tabindex="0">
          ${avatarHtml(u.avatarUrl, u.displayName || u.email, 'avatar-sm')}
          <div class="me-meta">
...
function renderTopbar(){
  ...
  const tags = [];
  tags.push(`<span class="role-badge${u.systemRole === 'site_admin' ? ' role-admin' : ''}">${escapeHtml(roleLabel(u))}</span>`);
